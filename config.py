...
OWNER_USERNAME = getenv("OWNER_USERNAME","kyqamatq")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "ROYAAL_FANTASTIC_BOT")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "˹ROYAAL MANISH ˼")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "˹ROYAAL MANISH ˼")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002144655727))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID",6132670595 ))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+pc1zBR6PPhhiYTdl")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+pc1zBR6PPhhiYTdl")
...
TG_VIDEO_FILESIZE_LIMIT = int(getennv("TG_VIDEO_FILESIZE_LIMIT", 1073741824))
